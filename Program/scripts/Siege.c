...
bool CheckQuestColonyList(string sColony)
{
    ...
    if (CheckAttribute(pchar, "questTemp.CapBloodLine") && Pchar.questTemp.CapBloodLine == true && sColony == "Bridgetown")
        return false;
    ...
    if (CheckAttribute(pchar, "questTemp.NationQuest"))
    {
        ...
        {
        case ENGLAND:
            if (sColony == "SentJons" || sColony == "Beliz" || sColony == "Villemstad" || sColony == "PortRoyal" || sColony == "SanJuan" || sColony == "LaVega" || sColony == "Havana" || sColony == "Santiago")
                return false;
            break;
            /*SentJons
                Beliz
        ...
        case FRANCE:
            if (sColony == "FortFrance" || sColony == "Villemstad" || sColony == "Havana" || sColony == "Guadeloupe" || sColony == "Cumana" || sColony == "Tortuga" || sColony == "PortPax")
                return false;
            break;
            /*
            FortFrance
        ...
        case SPAIN:
            if (sColony == "PortRoyal" || sColony == "Santiago" || sColony == "Villemstad" || sColony == "Maracaibo" || sColony == "Tortuga" || sColony == "Panama" || sColony == "Cumana" || sColony == "LaVega" || sColony == "Havana" || sColony == "SentJons")
                return false;
            break;
            /*
            PortRoyal
        ...
        case HOLLAND:
            if (sColony == "Marigo" || sColony == "Villemstad" || sColony == "PortRoyal" || sColony == "LaVegae" || sColony == "Cartahena" || sColony == "Tortuga")
                return false;
            break;
            /*
             Marigo
