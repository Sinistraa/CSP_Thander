...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "AT_PZD_PU_4":
    		dialog.text = "Знаете, если вы кого-то ищите, поспрашивайте у местных подёнщиков в порту, они же общаются с прибывающими моряками. Днём, правда, им не до болтовни, но по вечерам они часто разбивают лагеря прямо тут на берегу, только прихватите чего-нибудь для, так сказать, поддержания лёгкой беседы.";
    		link.l1 = "Благодарю. Попробую воспользоваться вашим советом.";
