void ProcessDialogEvent()
{
	...
	case "Hi":
		dialog.text = "Это всё Морган! Йа, только ОН, единственный, кто выслушал меня и осознал гениальность моих изобретений, которые служат теперь на благо короны Англии!\n" +
					  "Сейчас я работаю над новым проектом, который позволит мне возвести целый город в кратчайшие сроки. Он затмит собой все остальные колонии карибского архипелага, йа! Точно вам говорю! А может и всего мира, кто знает..." link.l1 = "Вот как? Достаточно интересно.";
