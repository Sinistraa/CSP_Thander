...
void ProcessDialogEvent()
{
	...
	case "DestroyGhost_1":
		...
		{
		case "пещера":
			sTemp = "Дело в том, что пещера, находящаяся возле нашего города, стала прибежищем нечисти!";
			break;
		case "Пещера":
			sTemp = "Дело в том, что пещера, находящаяся возле нашего города, стала прибежищем нечисти!";
			break;
		case "грот":
			sTemp = "Дело в том, что грот, находящийся возле нашего города, стал прибежищем нечисти!";
			break;
		case "Грот":
			sTemp = "Дело в том, что грот, находящийся возле нашего города, стал прибежищем нечисти!";
			break;
		case "подземелье":
			sTemp = "Дело в том, что подземелье, находящееся возле нашего города, стало прибежищем нечисти!";
			break;
		case "Подземелье":
			sTemp = "Дело в том, что подземелье, находящееся возле нашего города, стало прибежищем нечисти!";
			break;
	...
	case "GhostShip_S2":
		...
		AddSimpleRumourCity(LinkRandPhrase("Наш святой отец, " + GetFullName(npchar) + ", рассказал о том, что вы очистили от нечисти " + sTemp + " близ нашего города. Богоугодное дело, скажу я вам...",
										   ...
										   "" + GetSexPhrase("Капитан", "Девушка") + ", это вы очистили " + sTemp + " рядом с нашим городом от нечисти? Знайте, что мы все вам очень благодарны!"),
							npchar.city, 10, 1, "");
		ChangeCharacterReputation(pchar, 5);
	...
	case "NightGuard_noLook":
		...
		AddSimpleRumourCity(LinkRandPhrase("Говорят, что вы дежурите в нашей церкви по ночам...",
										   ...
										   "Наш святой отец, " + GetFullName(npchar) + ", упомянул, что вы несли караул по ночам в нашей церкви."),
							npchar.city, 10, 1, "");
		break;
	case "NightGuard_fight":
		...
		AddSimpleRumourCity(LinkRandPhrase("Говорят, что вы ночью вы поймали бандитов в нашей церкви! Огромное вам спасибо!",
										   ...
										   "Наш святой отец, " + GetFullName(npchar) + ", только о том и говорит, как вы спасли нашу церковную утварь той ночью..."),
							npchar.city, 10, 1, "");
		break;
