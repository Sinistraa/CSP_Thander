...
void ProcessDialogEvent()
{
	...
	case "First":
		...
		link.l1.go = "Meeting";
		if (pchar.sex != "woman")
			LAi_CharacterPlaySoundAtOnce(NPChar, "Salazar_1_man");
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Salazar_1_woman");
		break;
	...
	case "Last":
		...
		link.l1.go = "Last_2";
		if (pchar.sex != "woman")
			LAi_CharacterPlaySoundAtOnce(NPChar, "Salazar_4_man");
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Salazar_4_woman");
		break;
