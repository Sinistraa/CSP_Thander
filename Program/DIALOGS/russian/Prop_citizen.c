...
void ProcessDialogEvent()
{
	...
	case "First time":
		...
		if (NPChar.quest.meeting == "0")
		{
			...
			dialog.Text = NPCharRepPhrase(npchar,
										  LinkRandPhrase(DLG_TEXT_BASE[19], DLG_TEXT_BASE[20], DLG_TEXT_BASE[21]) + GetFullName(npchar) + LinkRandPhrase(DLG_TEXT_BASE[22], DLG_TEXT_BASE[23] + NPCharSexPhrase(NPChar, DLG_TEXT_BASE[24], DLG_TEXT_BASE[25]) + DLG_TEXT_BASE[26], DLG_TEXT_BASE[27]),
		...
		else
		{
			...
			{
				link.l4 = NPCharSexPhrase(npchar, LinkRandPhrase(DLG_TEXT_BASE[61] + XI_ConvertString("Colony" + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city + "Gen") + "!", DLG_TEXT_BASE[62] + XI_ConvertString("Colony" + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city + "Gen") + DLG_TEXT_BASE[63], DLG_TEXT_BASE[64] + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].lastname + DLG_TEXT_BASE[65]),
			...
			dialog.Text = NPCharRepPhrase(npchar,
										  PCharRepPhrase(LinkRandPhrase(DLG_TEXT_BASE[71] + GetFullName(Pchar) + DLG_TEXT_BASE[72], DLG_TEXT_BASE[73] + Pchar.name, DLG_TEXT_BASE[74] + GetFullName(Pchar)) + LinkRandPhrase(DLG_TEXT_BASE[75], DLG_TEXT_BASE[76], DLG_TEXT_BASE[77]) + LinkRandPhrase(DLG_TEXT_BASE[78], DLG_TEXT_BASE[79], DLG_TEXT_BASE[80]),
														 LinkRandPhrase(TimeGreeting() + DLG_TEXT_BASE[81], DLG_TEXT_BASE[82] + GetAddress_Form(NPChar) + " ", DLG_TEXT_BASE[83]) + GetFullName(Pchar) + LinkRandPhrase(DLG_TEXT_BASE[84], DLG_TEXT_BASE[85], DLG_TEXT_BASE[86])

															 ),

										  PCharRepPhrase(LinkRandPhrase(DLG_TEXT_BASE[87], DLG_TEXT_BASE[88] + GetAddress_Form(NPChar) + " ", DLG_TEXT_BASE[89]) + GetFullName(Pchar) + LinkRandPhrase(DLG_TEXT_BASE[90] + NPCharSexPhrase(NPChar, " ", DLG_TEXT_BASE[91]) + DLG_TEXT_BASE[92], DLG_TEXT_BASE[93] + NPCharSexPhrase(NPChar, " ", DLG_TEXT_BASE[94]) + DLG_TEXT_BASE[95], DLG_TEXT_BASE[96]) + LinkRandPhrase(DLG_TEXT_BASE[97], DLG_TEXT_BASE[98], DLG_TEXT_BASE[99] + NPCharSexPhrase(NPChar, DLG_TEXT_BASE[100], DLG_TEXT_BASE[101])),
	...
	case "Proposition_AfterSex_2":
		...
		break;
	case "Meeting":
		dialog.Text = NPCharRepPhrase(npchar, LinkRandPhrase(DLG_TEXT_BASE[112] + GetFullName(Pchar) + "?", DLG_TEXT_BASE[113] + PChar.name + "?", DLG_TEXT_BASE[114] + GetFullName(Pchar) + ".") + DLG_TEXT_BASE[115],
		...
		if (CheckAttribute(pchar, "GenQuest.SeekSpy.City") && pchar.location == (npchar.city + "_town"))
		{
			link.l4 = NPCharSexPhrase(npchar, LinkRandPhrase(DLG_TEXT_BASE[128] + XI_ConvertString("Colony" + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city + "Gen") + "!", DLG_TEXT_BASE[129] + XI_ConvertString("Colony" + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city + "Gen") + DLG_TEXT_BASE[130], DLG_TEXT_BASE[131] + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].lastname + DLG_TEXT_BASE[132]),
	...
	case "SitySpy_1":
		...
		if (sld.chr_ai.type == "merchant")
			pchar.GenQuest.SeekSpy.time = 0.0;
