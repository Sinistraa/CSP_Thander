...
void ProcessDialogEvent()
{
	...
	case "CoolStory":
		...
		{
		case 0:
			coolstory = "Нужно непременно добавить в энциклопедию список уникальных квестов и описание в каких городах их можно взять." LAi_CharacterPlaySound(NPChar, "Fan_CoolStory_0");
			break;
		case 1:
