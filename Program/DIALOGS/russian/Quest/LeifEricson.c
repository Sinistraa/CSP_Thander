...
void ProcessDialogEvent()
{
	...
	case "Body_Change":
		...
		{
			Pchar.questTemp.Ascold.heromodel = pchar.heromodel;
			DeleteAttribute(pchar, "heromodel");
		}
	...
	case "Step_29":
		...
		if (CheckAttribute(Pchar, "questTemp.Ascold.heromodel"))
			pchar.heromodel = Pchar.questTemp.Ascold.heromodel;
		//FaceMaker(pchar);
		SetNewModelToChar(pchar);
		npchar.model = "Mummy";
