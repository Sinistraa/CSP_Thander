...
void ProcessDialogEvent()
{
	...
	case "GhostCapt_Prize":
		dialog.text = "Приветствую тебя, " + GetSexPhrase("юноша", "леди") + "! Давненько в нашем болоте не появлялись такие отважные и умелые капитаны." link.l1 = "Ты кто?! И откуда здесь взялся?";
