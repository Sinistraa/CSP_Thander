...
void ProcessDialogEvent()
{
	...
	case "BS_KS_7": //Обращаемся к матросу
		...
		if (pchar.location != "Shore39")
		{
			...
			order2 = "";
		if (order1 == "" && order2 == "")
			order3 = "Вернись на корабль и будь начеку. Если вдруг патруль, скажи, что руль заклинило, до верфи не дойти.";
		else
			order3 = "Если вдруг патруль, скажи, что руль заклинило, до верфи не дойти.";
