...
void ProcessDialogEvent()
{
	...
	case "Samil":
		...
		link.l1.go = "Samil_2";
		if (pchar.sex != "woman")
			LAi_CharacterPlaySoundAtOnce(NPChar, "Samil_1_man");
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Samil_1_woman");
		break;
	...
	case "Samil_4":
		...
		if (pchar.sex != "woman")
			LAi_CharacterPlaySoundAtOnce(NPChar, "Samil_4_man");
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Samil_4_woman");
		break;
