void ProcessDialogEvent()
{
	...
	case "Isabella_1":
		...
		{
			link.l2 = "Люк мой старый друг. Я выполнял" + GetSexPhrase("", "а") + " его просьбу. Когда я вернул" + GetSexPhrase("ся", "лась") + " его нигде не было. Меня это встревожило." link.l2.go = "PeaceDial";
		}
