...
void ProcessDialogEvent()
{
	...
	case "Step_F2_4":
		...
		for (i = 1; i <= 2; i++)
		{
			...
			LAi_SetStayType(sld);
			if (i == 2)
				ChangeCharacterAddressGroup(sld, "Villemstad_tavern", "tables", "stay2");
			else
				ChangeCharacterAddressGroup(sld, "Villemstad_tavern", "goto", "goto3");
	...
	case "Step_F6_16":
		...
		for (i = 1; i <= 2; i++)
		{
			iTemp = GetCharacterIndex("Captain_" + i) if (iTemp > 0)
			{
