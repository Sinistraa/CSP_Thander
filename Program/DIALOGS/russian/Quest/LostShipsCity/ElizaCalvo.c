...
void ProcessDialogEvent()
{
	...
	case "First time":
		...
		if (npchar.quest.meeting == "0")
		{
			...
			{
				if (npchar.location == "SantaFlorentinaShipInside4")
					dialog.text = "Этот шторм был очень сильным, сеньор" + GetSexPhrase("", "ита") + ", вам очень повезло, что вы смогли выбраться к нам... Меня зовут " + GetFullName(npchar) + ", в этом доме я хозяйка.";
				else
					dialog.text = "Этот шторм был очень сильным, сеньор" + GetSexPhrase("", "ита") + ", вам очень повезло, что вы смогли выбраться к нам... Меня зовут " + GetFullName(npchar) + ".";
		...
		{
			if (npchar.location == "SantaFlorentinaShipInside4")
				dialog.text = "Что вам нужно у меня в доме, сеньор" + GetSexPhrase("", "ита") + "?";
			else
