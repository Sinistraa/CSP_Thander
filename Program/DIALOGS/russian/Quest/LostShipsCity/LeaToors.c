...
void ProcessDialogEvent()
{
	...
	case "First time":
		...
		if (npchar.quest.meeting == "0")
		{
			...
			{
				if (npchar.location == "PlutoStoreSmall")
					dialog.text = "Приветствую вас, " + GetSexPhrase("минхер", "госпожа") + ", у себя дома, вы можете переждать у меня этот шторм. Меня зовут " + GetFullName(npchar) + ".";
				else
					dialog.text = "Приветствую вас, минхер. Меня зовут " + GetFullName(npchar) + ".";
			...
			{
				if (npchar.location == "PlutoStoreSmall")
					dialog.text = "Приветствую вас, " + GetSexPhrase("минхер", "госпожа") + ", у себя дома. Меня зовут " + GetFullName(npchar) + ".";
				else
					dialog.text = "Приветствую вас, " + GetSexPhrase("минхер", "госпожа") + ". Меня зовут " + GetFullName(npchar) + ".";
