...
void ProcessDialogEvent()
{
	...
	case "Term_2":
		...
		link.l1.go = "Term_3";
		if (startherotype > 0 && startherotype < 12)
			LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_3_" + startherotype);
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_3_unknown");
		break;
	...
	case "Term_8":
		...
		link.l1.go = "Term_9";
		if (pchar.sex != "woman")
			LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_9_man");
		else
			LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_9_woman");
		break;
	...
	case "Term_9_2":
		...
		link.l1.go = "Term_11";
		if (startherotype > 0 && startherotype < 12)
			LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_11_" + startherotype);
		else
		{
			if (pchar.sex != "woman")
				LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_11_man");
			else
				LAi_CharacterPlaySoundAtOnce(NPChar, "Terminator_11_woman");
		}
