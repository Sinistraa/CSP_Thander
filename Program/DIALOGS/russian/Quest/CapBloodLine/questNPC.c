...
void ProcessDialogEvent()
{
    ...
    case "Merchant_1":
        ...
        if (Pchar.questTemp.CapBloodLine.stat == "PrepareToEscape")
            Pchar.questTemp.CapBloodLine.stat = "ReadyToEscape"; //fix чтоб не сбивать
    ...
    case "SQStep_1":
        ...
        if (findsubstr(smodel, "eng_mush", 0) != -1)
            smodel = "sold_eng_" + (rand(7) + 1);
    ...
    case "QHStep_3":
        ...
        if (CheckNationLicence(ENGLAND))
            TakeNationLicence(ENGLAND);
    ...
    case "QSTStep_0":
        ...
        link.l1.go = "Exit_Away";
        Pchar.questTemp.sLocator = "reload1_back";
        if (npchar.location == "CommonRoom_MH7")
            Pchar.questTemp.sLocator = "reload1" Pchar.questTemp.iTime = -1;
    ...
    case "QSTStep_5":
        ...
        Pchar.questTemp.sLocator = "reload1_back";
        if (npchar.location == "CommonRoom_MH7")
            Pchar.questTemp.sLocator = "reload1";
        Pchar.questTemp.iTime = -1;
