...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if(CheckAttribute(pchar, "questTemp.AT_PZD_Lavochniki"))
			{
            ...
            if(CheckAttribute(pchar, "questTemp.AT_PZD_Lavochniki_2"))
            {
			...
			if(CheckAttribute(pchar, "questTemp.AT_PZD_Lavochniki_3"))
            {
