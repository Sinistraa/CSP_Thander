...
void ProcessDialogEvent()
{
	...
	case "crew":
		...
		case 1:
			...
			break;
		case 2:
			sTemp = "Мы с друзьями две недели назад вернулись из рейса, хозяин нас рассчитал, и мы здорово повеселились эти денечки. Однако ветер свищет в матросском кармане - значит, снова пора в море. Не наймете ли нас на свое судно, капитан?";
			break;
		}
		dialog.text = sTemp;
	...
	case "crew_1":
		...
		{
		case 0:
			sTemp = "Хотя лучше всего прочего мы умеем обращаться с парусами и снастями. Без лишней скромности скажу: мы на этом деле собаку съели, так что не подведем даже в самый свирепый шторм!";
			break;
		case 1:
	...
	case "crew_comp2":
		...
		{
		case 0:
			ChangeCrewExp(rChar, "Sailors", iTemp);
			break;
		case 1:
			ChangeCrewExp(rChar, "Cannoners", iTemp);
			break;
		case 2:
			ChangeCrewExp(rChar, "Soldiers", iTemp);
			break;
		}
		//увеличиваем мораль
