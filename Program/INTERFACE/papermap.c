...
bool AnyoneHaveMap(string mapid)
{
	if (HaveMap(1, mapid))
		return true; //player
	if (HaveMap(sti(pchar.Fellows.Passengers.navigator), mapid))
		return true;
	//Boyer mod
	...
	{
		if (HaveMap(GetOfficersIndex(pchar, i), mapid))
			return true;
	}
	//End Boyer mod
	return false;
...
void InitSubMaps()
{
	...
	submaps.turks.x1 = 370 submaps.turks.y1 = 70 submaps.turks.x2 = 400 submaps.turks.y2 = 110 submaps.turks.map = "map_terks"

																												   submaps.Puerto_Rico.x1 = 375 submaps.Puerto_Rico.y1 = 180 submaps.Puerto_Rico.x2 = 420 submaps.Puerto_Rico.y2 = 210 submaps.Puerto_Rico.map = "map_puerto"

																																																																 submaps.bermuda.x1 = 465 submaps.bermuda.y1 = 80 submaps.bermuda.x2 = 495 submaps.bermuda.y2 = 115 submaps.bermuda.map = "map_bermudas"

																																																																																														  submaps.st_martin.x1 = 470 submaps.st_martin.y1 = 170 submaps.st_martin.x2 = 490 submaps.st_martin.y2 = 195 submaps.st_martin.map = "map_sm"

																																																																																																																															  submaps.Nevis.x1 = 420 submaps.Nevis.y1 = 220 submaps.Nevis.x2 = 445 submaps.Nevis.y2 = 245 submaps.Nevis.map = "map_nevis"

																																																																																																																																																											  submaps.Antigua.x1 = 465 submaps.Antigua.y1 = 250 submaps.Antigua.x2 = 495 submaps.Antigua.y2 = 280 submaps.Antigua.map = "map_antigua"

																																																																																																																																																																																										submaps.Guadaloupe.x1 = 380 submaps.Guadaloupe.y1 = 270 submaps.Guadaloupe.x2 = 430 submaps.Guadaloupe.y2 = 310 submaps.Guadaloupe.map = "map_guad"

																																																																																																																																																																																																																												 submaps.Dominca.x1 = 440 submaps.Dominca.y1 = 325 submaps.Dominca.x2 = 465 submaps.Dominca.y2 = 355 submaps.Dominca.map = "map_dominica"

																																																																																																																																																																																																																																																										   submaps.Martinique.x1 = 390 submaps.Martinique.y1 = 345 submaps.Martinique.x2 = 416 submaps.Martinique.y2 = 377 submaps.Martinique.map = "map_martiniqua"

																																																																																																																																																																																																																																																																																													submaps.Barbados.x1 = 470 submaps.Barbados.y1 = 370 submaps.Barbados.x2 = 500 submaps.Barbados.y2 = 400 submaps.Barbados.map = "map_barbados"

																																																																																																																																																																																																																																																																																																																												   submaps.trinidad.x1 = 460 submaps.trinidad.y1 = 420 submaps.trinidad.x2 = 490 submaps.trinidad.y2 = 460 submaps.trinidad.map = "map_trinidad"

																																																																																																																																																																																																																																																																																																																																																												  submaps.cayman.x1 = 190 submaps.cayman.y1 = 200 submaps.cayman.x2 = 215 submaps.cayman.y2 = 225 submaps.cayman.map = "map_cayman"

																																																																																																																																																																																																																																																																																																																																																																																									   submaps.Jamaica.x1 = 200 submaps.Jamaica.y1 = 290 submaps.Jamaica.x2 = 275 submaps.Jamaica.y2 = 330 submaps.Jamaica.map = "map_jam"

																																																																																																																																																																																																																																																																																																																																																																																																																								 submaps.Curacao.x1 = 350 submaps.Curacao.y1 = 410 submaps.Curacao.x2 = 400 submaps.Curacao.y2 = 440 submaps.Curacao.map = "map_Curacao"

																																																																																																																																																																																																																																																																																																																																																																																																																																																						   submaps.beliz.x1 = 85 submaps.beliz.y1 = 230 submaps.beliz.x2 = 115 submaps.beliz.y2 = 270 submaps.beliz.map = "map_beliz"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																		  submaps.perl_divers.x1 = 15 submaps.perl_divers.y1 = 280 submaps.perl_divers.x2 = 160 submaps.perl_divers.y2 = 410 submaps.perl_divers.map = "map_Pearl"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																					   submaps.cumana.x1 = 420 submaps.cumana.y1 = 460 submaps.cumana.x2 = 460 submaps.cumana.y2 = 480 submaps.cumana.map = "map_cumana"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																			submaps.center_main.x1 = 285 submaps.center_main.y1 = 445 submaps.center_main.x2 = 395 submaps.center_main.y2 = 485 submaps.center_main.map = "map_maracaibo"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						  submaps.panama.x1 = 200 submaps.panama.y1 = 460 submaps.panama.x2 = 245 submaps.panama.y2 = 485 submaps.panama.map = "map_panama"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																			   submaps.South_Main.x1 = 200 submaps.South_Main.y1 = 450 submaps.South_Main.x2 = 510 submaps.South_Main.y2 = 500 submaps.South_Main.map = "map_maine_2"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						submaps.West_Main.x1 = 15 submaps.West_Main.y1 = 140 submaps.West_Main.x2 = 165 submaps.West_Main.y2 = 500 submaps.West_Main.map = "map_maine_1"

																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						   submaps.santa_catalina.x1 = 140 submaps.santa_catalina.y1 = 350 submaps.santa_catalina.x2 = 200 submaps.santa_catalina.y2 = 500 submaps.santa_catalina.map = "map_santa"
}
void SelectRColony()
{
