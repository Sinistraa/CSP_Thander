...
void SelectMoneyForTransfer(bool bGive, bool bAll)
{
	...
	if (sti(PChar.ColonyBuilding.Money.Temp) > sti(PChar.ColonyBuilding.Money))
	{
		PChar.ColonyBuilding.Money.Temp = sti(PChar.ColonyBuilding.Money);
	}
...
void OpenBuild(string sBuild)
{
	...
	case "Store":
		...
		break;
	case "Shipyard":
		sCharacter += "_shipyarder";
		sModel = "shipowner_" + (rand(15) + 1);
		break;

	case "Tavern":
		sCharacter += "_tavernkeeper";
	...
	case "Bank":
		sCharacter += "_usurer";
		sModel = "usurer_" + (rand(7) + 1);
		break;
	case "Church":
		sCharacter += "_Priest";
		sModel = "priest_" + (rand(3) + 1);
		break;
	case "HeadPort":
		sCharacter += "_PortMan";
		sModel = "usurer_" + (rand(7) + 1);
...
void SelectBuildsMenu(string sMenu)
{
	...
	case "NormalBuilds":
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				GameInterface.strings.StoreCost = "Цена: " + sti(PChar.ColonyBuilding.Store.Cost) / 2;
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Store.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Store.Cost;
	...
	case "Expiditions":
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "ExpiditionCost", "Цена: " + sti(PChar.ColonyBuilding.Expidition.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 355, 238, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Expidition.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Expidition.Cost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "StoreHouseCost", "Цена: " + sti(PChar.ColonyBuilding.StoreHouse.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 238, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.StoreHouse.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.StoreHouse.Cost;
		...
		if (PChar.ColonyBuilding.StoreHouse == true)
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					CreateString(true, "StoreHouseResizeCost", "Цена: " + sti(PChar.ColonyBuilding.StoreHouse.ResizeCost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 238, SCRIPT_ALIGN_LEFT, 1.0);
				else
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					NeedMoney = PChar.ColonyBuilding.StoreHouse.ResizeCost / 2;
				else
					NeedMoney = PChar.ColonyBuilding.StoreHouse.ResizeCost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "PlantationCost", "Цена: " + sti(PChar.ColonyBuilding.Plantation.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 238, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Plantation.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Plantation.Cost;
		...
		if (PChar.ColonyBuilding.Plantation == true)
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					CreateString(true, "PlantationResizeCost", "Цена: " + sti(PChar.Plantation.ResizeMoney) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 238, SCRIPT_ALIGN_LEFT, 1.0);
				else
			...
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.Plantation.ResizeMoney / 2;
			else
				NeedMoney = PChar.Plantation.ResizeMoney;
	...
	case "ProBuilds":
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				GameInterface.strings.BankCost = "Цена: " + sti(PChar.ColonyBuilding.Bank.Cost) / 2;
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Bank.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Bank.Cost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				GameInterface.strings.ChurchCost = "Цена: " + sti(PChar.ColonyBuilding.Church.Cost) / 2;
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Church.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Church.Cost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				GameInterface.strings.HeadportCost = "Цена: " + sti(PChar.ColonyBuilding.Headport.Cost) / 2;
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Headport.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Headport.Cost;
	...
	case "Mines":
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "GoldMineCost", "Цена: " + sti(PChar.ColonyBuilding.GoldMine.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 355, 513, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.GoldMine.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.GoldMine.Cost;
		...
		if (PChar.ColonyBuilding.GoldMine == true)
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					CreateString(true, "GoldMineResizeCost", "Цена: " + sti(PChar.ColonyBuilding.GoldMine.ResizeCost) / 2, FONT_NORMAL, COLOR_NORMAL, 355, 513, SCRIPT_ALIGN_LEFT, 1.0);
				else
			...
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.GoldMine.ResizeCost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.GoldMine.ResizeCost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "SilverMineCost", "Цена: " + sti(PChar.ColonyBuilding.SilverMine.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 513, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.SilverMine.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.SilverMine.Cost;
		...
		if (PChar.ColonyBuilding.SilverMine == true)
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					CreateString(true, "SilverMineResizeCost", "Цена: " + sti(PChar.ColonyBuilding.SilverMine.ResizeCost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 513, SCRIPT_ALIGN_LEFT, 1.0);
				else
			...
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.SilverMine.ResizeCost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.SilverMine.ResizeCost;
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				CreateString(true, "IronMineCost", "Цена: " + sti(PChar.ColonyBuilding.IronMine.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 513, SCRIPT_ALIGN_LEFT, 1.0);
			else
		...
		else
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					NeedMoney = PChar.ColonyBuilding.IronMine.Cost / 2;
				else
					NeedMoney = PChar.ColonyBuilding.IronMine.Cost;
		...
		if (PChar.ColonyBuilding.IronMine == true)
		{
			...
			{
				if (CheckAttribute(pchar, "VedekerDiscount"))
					CreateString(true, "IronMineResizeCost", "Цена: " + sti(PChar.ColonyBuilding.IronMine.ResizeCost) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 513, SCRIPT_ALIGN_LEFT, 1.0);
				else
			...
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.IronMine.ResizeCost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.IronMine.ResizeCost;
...
void SetInformation()
{
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "StoreCost", "Цена: " + sti(PChar.ColonyBuilding.Store.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 355, 238, SCRIPT_ALIGN_LEFT, 1.0);
		else
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "ShipyardCost", "Цена: " + sti(PChar.ColonyBuilding.Shipyard.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 238, SCRIPT_ALIGN_LEFT, 1.0);
		else
	...
	else
	{
		...
		{
			if (CheckAttribute(pchar, "VedekerDiscount"))
				NeedMoney = PChar.ColonyBuilding.Shipyard.Cost / 2;
			else
				NeedMoney = PChar.ColonyBuilding.Shipyard.Cost;
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "TavernCost", "Цена: " + sti(PChar.ColonyBuilding.Tavern.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 238, SCRIPT_ALIGN_LEFT, 1.0);
		else
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			NeedMoney = PChar.ColonyBuilding.Tavern.Cost / 2;
		else
			NeedMoney PChar.ColonyBuilding.Tavern.Cost;
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "BankCost", "Цена: " + sti(PChar.ColonyBuilding.Bank.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 355, 513, SCRIPT_ALIGN_LEFT, 1.0);
		else
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "ChurchCost", "Цена: " + sti(PChar.ColonyBuilding.Church.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 500, 513, SCRIPT_ALIGN_LEFT, 1.0);
		else
	...
	{
		if (CheckAttribute(pchar, "VedekerDiscount"))
			CreateString(true, "HeadportCost", "Цена: " + sti(PChar.ColonyBuilding.Headport.Cost) / 2, FONT_NORMAL, COLOR_NORMAL, 645, 513, SCRIPT_ALIGN_LEFT, 1.0);
		else
...
void CheckInfoBuildCount(bool left)
{
	...
	if (iInfoBuildCount < 0)
	{
		iInfoBuildCount = 11;
	}
	if (iInfoBuildCount > 11)
	{
		iInfoBuildCount = 0;
	}
...
void SelectTexture(bool left)
{
	...
	if (sti(PChar.ColonyBuilding.CurrentIconsTexture) < 1)
	{
		PChar.ColonyBuilding.CurrentIconsTexture = 3;
	}
	if (sti(PChar.ColonyBuilding.CurrentIconsTexture) > 3)
	{
