...
void wdmRecalcReloadToSea()
{
		...
		if (wdmSetCurrentShipData(i))
		{
			...
			if (iRealEncounterType != ENCOUNTER_TYPE_BARREL && iRealEncounterType != ENCOUNTER_TYPE_BOAT)
			{
				...
				case ENGLAND:
					...
					{
						ef = true;
						flagtypes[flagsnum] = "loading\Enc_Eng.tga";
						flagsnum += 1;
					}
					break;
				case FRANCE:
					...
					{
						ff = true;
						flagtypes[flagsnum] = "loading\Enc_Fra.tga";
						flagsnum += 1;
					}
					break;
				case SPAIN:
					...
					{
						sf = true;
						flagtypes[flagsnum] = "loading\Enc_Spa.tga";
						flagsnum += 1;
					}
					break;
				case HOLLAND:
					...
					{
						hf = true;
						flagtypes[flagsnum] = "loading\Enc_Hol.tga";
						flagsnum += 1;
					}
					break;
				case PIRATE:
					...
					{
						pf = true;
						flagtypes[flagsnum] = "loading\Enc_Pir.tga";
						flagsnum += 1;
					}
					break;
				}
	...
	if (isShipEncounterType > 1)
	{
		for (int j = 1; j < flagsnum; j++)
		{
			if (flagsnum == 3)
			{
				SetNewPicture("ENC_NATIONS2" + j + "_PICTURE", flagtypes[j]);
				SetNewPicture("ENC_NATIONS2B" + (j - 1) + "_PICTURE", "loading\EncFight.tga");
			};
			if (flagsnum == 4)
			{
				SetNewPicture("ENC_NATIONS3" + j + "_PICTURE", flagtypes[j]);
				SetNewPicture("ENC_NATIONS3B" + (j - 1) + "_PICTURE", "loading\EncFight.tga");
			};
			if (flagsnum == 5)
			{
				SetNewPicture("ENC_NATIONS4" + j + "_PICTURE", flagtypes[j]);
				SetNewPicture("ENC_NATIONS4B" + (j - 1) + "_PICTURE", "loading\EncFight.tga");
			};
			if (flagsnum == 6)
			{
				SetNewPicture("ENC_NATIONS5" + j + "_PICTURE", flagtypes[j]);
				SetNewPicture("ENC_NATIONS5B" + (j - 1) + "_PICTURE", "loading\EncFight.tga");
			};
		}
