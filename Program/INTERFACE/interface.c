...
string GetSaveDataString(string label)
{
	...
	{
		fighter1 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 0));
	}
	...
	{
		fighter2 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 1));
	}
	...
	{
		fighter3 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 2));
	}
	...
	{
		fighter4 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 3));
	}
	if (GetOfficersIndex(pchar, 4) < 0)
	{
		fighter5 = "*";
	}
	else
	{
		fighter5 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 4));
	}
	if (GetOfficersIndex(pchar, 5) < 0)
	{
		fighter6 = "*";
	}
	else
	{
		fighter6 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 5));
	}
	if (GetOfficersIndex(pchar, 6) < 0)
	{
		fighter7 = "*";
	}
	else
	{
		fighter7 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 6));
	}
	if (GetOfficersIndex(pchar, 7) < 0)
	{
		fighter8 = "*";
	}
	else
	{
		fighter8 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 7));
	}
	if (GetOfficersIndex(pchar, 8) < 0)
	{
		fighter9 = "*";
	}
	else
	{
		fighter9 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 8));
	}
	if (GetOfficersIndex(pchar, 9) < 0)
	{
		fighter10 = "*";
	}
	else
	{
		fighter10 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 9));
	}
	if (GetOfficersIndex(pchar, 10) < 0)
	{
		fighter11 = "*";
	}
	else
	{
		fighter11 = GetMinifiedFaceGroupName(GetOfficersIndex(pchar, 10));
	}
	// specials pictures
	...
	{
		navigator = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.navigator));
	}
	...
	{
		boatswain = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.boatswain));
	}
	...
	{
		cannoner = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.cannoner));
	}
	...
	{
		doctor = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.doctor));
	}
	...
	{
		treasurer = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.treasurer));
	}
	...
	{
		carpenter = GetMinifiedFaceGroupName(sti(pchar.Fellows.Passengers.carpenter));
	}
	//GetCurLocationName()
