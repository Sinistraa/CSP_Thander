...
void LoadActivePerkShower()
{
	...
	{ // морская часть
		if (InterfaceStates.AltIntIcons)
			objActivePerkShower.Textures.t0.file = "battle_interface\list_icons_Konshud.tga";
		else
	...
	{ // земная часть
		if (InterfaceStates.AltIntIcons)
			objActivePerkShower.Textures.t0.file = "battle_interface\LandCommands_Konshud.tga";
		else
