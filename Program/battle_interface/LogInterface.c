...
void CreateSeaActionsEnvironment()
{
	...
	if (InterfaceStates.AltIntIcons)
		ILogAndActions.ActiveActions.TextureName = "battle_interface\List_icons_Konshud.tga";
	else
...
void CreateLandActionsEnvironment()
{
	...
	if (InterfaceStates.AltIntIcons)
		ILogAndActions.ActiveActions.TextureName = "battle_interface\LandCommands_Konshud.tga";
	else
...
void CreateWorldMapActionsEnvironment()
{
	...
	if (InterfaceStates.AltIntIcons)
		ILogAndActions.ActiveActions.TextureName = "battle_interface\WorldMapCommands_Konshud.tga";
	else
...
void DrawCharacterHP(float myHP, float enemyHP)
{
	if (bYesBoardStatus == false)
	{
		...
		LayerAddObject(REALIZE, &IBoardingStatus, 1000);
