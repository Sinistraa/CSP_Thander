...
bool BI_SetSeaState()
{
	...
	if (bMapEnter)
		seaAlarmed = false;
	if (CheckAttribute(pchar, "GhostCap.Fight"))
		bMapEnter = false;
	return bMapEnter;
}
...
void SetShipPictureDataByShipTypeName(string sType)
{
	...
	case "tartane":
		...
		break; // Тартана
	case "plot":
		BI_intNRetValue[0] = 2 + 0 * 32;
		BI_intNRetValue[1] = 2 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Плот
	case "wartartane":
		BI_intNRetValue[0] = 4 + 0 * 32;
		BI_intNRetValue[1] = 4 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Баркас
	// 6-й КЛАСС	(12 кораблей)
	case "bermsloop":
		BI_intNRetValue[0] = 6 + 0 * 32;
		BI_intNRetValue[1] = 6 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лёг. Шлюп
	case "empress":
		BI_intNRetValue[0] = 8 + 0 * 32;
		BI_intNRetValue[1] = 8 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Джонка
	case "pink":
		BI_intNRetValue[0] = 10 + 0 * 32;
		BI_intNRetValue[1] = 10 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лёг. Шлюп
	case "lugger":
		BI_intNRetValue[0] = 12 + 0 * 32;
		BI_intNRetValue[1] = 12 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Люггер
	case "lugger_h":
		BI_intNRetValue[0] = 14 + 0 * 32;
		BI_intNRetValue[1] = 14 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Люггер
	case "speedy":
		BI_intNRetValue[0] = 16 + 0 * 32;
		BI_intNRetValue[1] = 16 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ср. Шлюп
	case "fr_sloop":
		BI_intNRetValue[0] = 18 + 0 * 32;
		BI_intNRetValue[1] = 18 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Шлюп
	case "galeoth_h":
		BI_intNRetValue[0] = 20 + 0 * 32;
		BI_intNRetValue[1] = 20 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Галеот
	case "sloop":
		BI_intNRetValue[0] = 22 + 0 * 32;
		BI_intNRetValue[1] = 22 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Шлюп
	case "sloop_b":
		BI_intNRetValue[0] = 24 + 0 * 32;
		BI_intNRetValue[1] = 24 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Шлюп
	case "neptunus":
		BI_intNRetValue[0] = 26 + 0 * 32;
		BI_intNRetValue[1] = 26 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Усил. Шлюп
	case "sophie":
		BI_intNRetValue[0] = 28 + 0 * 32;
		BI_intNRetValue[1] = 28 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Шлюп
	// 5-й КЛАСС	(13 кораблей)
	case "polacca":
		BI_intNRetValue[0] = 30 + 0 * 32;
		BI_intNRetValue[1] = 30 + 0 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Полакка
	case "barque":
		BI_intNRetValue[0] = 0 + 1 * 32;
		BI_intNRetValue[1] = 0 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Барк
	case "fr_postillionen":
		BI_intNRetValue[0] = 2 + 1 * 32;
		BI_intNRetValue[1] = 2 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Фрегат
	case "schooner":
		BI_intNRetValue[0] = 4 + 1 * 32;
		BI_intNRetValue[1] = 4 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Шхуна
	case "colonialschooner":
		BI_intNRetValue[0] = 6 + 1 * 32;
		BI_intNRetValue[1] = 6 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Шхуна
	case "xebec":
		BI_intNRetValue[0] = 8 + 1 * 32;
		BI_intNRetValue[1] = 8 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Щебека
	case "battlexebec":
		BI_intNRetValue[0] = 10 + 1 * 32;
		BI_intNRetValue[1] = 10 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Усил. Щебека
	case "xebeclight":
		BI_intNRetValue[0] = 12 + 1 * 32;
		BI_intNRetValue[1] = 12 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Щебека
	case "schoonerlight":
		BI_intNRetValue[0] = 14 + 1 * 32;
		BI_intNRetValue[1] = 14 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ср. Шхуна
	case "Mirage":
		BI_intNRetValue[0] = 16 + 1 * 32;
		BI_intNRetValue[1] = 16 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Шхуна
	case "polacre":
		BI_intNRetValue[0] = 18 + 1 * 32;
		BI_intNRetValue[1] = 18 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Полакр
	case "enslaver":
		BI_intNRetValue[0] = 20 + 1 * 32;
		BI_intNRetValue[1] = 20 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Бригантина
	case "shnyava":
		BI_intNRetValue[0] = 22 + 1 * 32;
		BI_intNRetValue[1] = 22 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Шнява
	// 4-й КЛАСС (24 корабля)
	case "brig":
		BI_intNRetValue[0] = 24 + 1 * 32;
		BI_intNRetValue[1] = 24 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Бриг
	case "brigheavy":
		BI_intNRetValue[0] = 26 + 1 * 32;
		BI_intNRetValue[1] = 26 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Бриг
	case "barkentine":
		BI_intNRetValue[0] = 28 + 1 * 32;
		BI_intNRetValue[1] = 28 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Баркентина
	case "brigantine":
		BI_intNRetValue[0] = 30 + 1 * 32;
		BI_intNRetValue[1] = 30 + 1 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Бригантина
	case "castelf":
		BI_intNRetValue[0] = 0 + 2 * 32;
		BI_intNRetValue[1] = 0 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Бригантина
	case "derfflinger":
		BI_intNRetValue[0] = 2 + 2 * 32;
		BI_intNRetValue[1] = 2 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Флейт
	case "interceptor":
		BI_intNRetValue[0] = 4 + 2 * 32;
		BI_intNRetValue[1] = 4 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ост-индец
	case "fleut":
		BI_intNRetValue[0] = 6 + 2 * 32;
		BI_intNRetValue[1] = 6 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Флейт
	case "po_fleut50":
		BI_intNRetValue[0] = 8 + 2 * 32;
		BI_intNRetValue[1] = 8 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Усил. Флейт
	case "galeon_l":
		BI_intNRetValue[0] = 10 + 2 * 32;
		BI_intNRetValue[1] = 10 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Галеон
	case "greyhound":
		BI_intNRetValue[0] = 12 + 2 * 32;
		BI_intNRetValue[1] = 12 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Корвет
	case "corvettelight":
		BI_intNRetValue[0] = 14 + 2 * 32;
		BI_intNRetValue[1] = 14 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Корвет
	case "packet_brig":
		BI_intNRetValue[0] = 16 + 2 * 32;
		BI_intNRetValue[1] = 16 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Бриг
	case "pdn":
		BI_intNRetValue[0] = 18 + 2 * 32;
		BI_intNRetValue[1] = 18 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лин. Бриг
	case "enterprise":
		BI_intNRetValue[0] = 20 + 2 * 32;
		BI_intNRetValue[1] = 20 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Ост-индец
	case "polacre_h":
		BI_intNRetValue[0] = 22 + 2 * 32;
		BI_intNRetValue[1] = 22 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Полакр
	case "caravel":
		BI_intNRetValue[0] = 24 + 2 * 32;
		BI_intNRetValue[1] = 24 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Каравелла
	case "FrigateMedium":
		BI_intNRetValue[0] = 26 + 2 * 32;
		BI_intNRetValue[1] = 26 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ср. Фрегат
	case "raafrigate":
		BI_intNRetValue[0] = 28 + 2 * 32;
		BI_intNRetValue[1] = 28 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ср. Фрегат
	case "caravel2":
		BI_intNRetValue[0] = 30 + 2 * 32;
		BI_intNRetValue[1] = 30 + 2 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Каравелла
	case "fleutwar":
		BI_intNRetValue[0] = 0 + 3 * 32;
		BI_intNRetValue[1] = 0 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Боев. Флейт
	case "fleutwarsat":
		BI_intNRetValue[0] = 2 + 3 * 32;
		BI_intNRetValue[1] = 2 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Тяж. Флейт
	case "galeontrader":
		BI_intNRetValue[0] = 4 + 3 * 32;
		BI_intNRetValue[1] = 4 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Торг. Корабль
	case "lydia":
		BI_intNRetValue[0] = 6 + 3 * 32;
		BI_intNRetValue[1] = 6 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Торг. Корабль
	// 3-й КЛАСС	(32 корабля)
	case "pinnace":
		BI_intNRetValue[0] = 8 + 3 * 32;
		BI_intNRetValue[1] = 8 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пинас
	case "dutchpinnace":
		BI_intNRetValue[0] = 10 + 3 * 32;
		BI_intNRetValue[1] = 10 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Пинас
	case "pinnacelight":
		BI_intNRetValue[0] = 12 + 3 * 32;
		BI_intNRetValue[1] = 12 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Двухпалуб. Пинас
	case "xebekvt":
		BI_intNRetValue[0] = 14 + 3 * 32;
		BI_intNRetValue[1] = 14 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Воен. Щебека
	case "felipe":
		BI_intNRetValue[0] = 16 + 3 * 32;
		BI_intNRetValue[1] = 16 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Галеон
	case "crimsonblood":
		BI_intNRetValue[0] = 18 + 3 * 32;
		BI_intNRetValue[1] = 18 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Корвет
	case "corvette":
		BI_intNRetValue[0] = 20 + 3 * 32;
		BI_intNRetValue[1] = 20 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Корвет
	case "frigate_l":
		BI_intNRetValue[0] = 22 + 3 * 32;
		BI_intNRetValue[1] = 22 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Корвет
	case "battlecorvette":
		BI_intNRetValue[0] = 24 + 3 * 32;
		BI_intNRetValue[1] = 24 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Корвет
	case "blackangel":
		BI_intNRetValue[0] = 26 + 3 * 32;
		BI_intNRetValue[1] = 26 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Корвет
	case "CoastalFrigate":
		BI_intNRetValue[0] = 28 + 3 * 32;
		BI_intNRetValue[1] = 28 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Береговой Фрегат
	case "fr_frigate":
		BI_intNRetValue[0] = 30 + 3 * 32;
		BI_intNRetValue[1] = 30 + 3 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Корсарский Фрегат
	case "jamaicaship":
		BI_intNRetValue[0] = 0 + 4 * 32;
		BI_intNRetValue[1] = 0 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Пинас
	case "theblackpearl":
		BI_intNRetValue[0] = 2 + 4 * 32;
		BI_intNRetValue[1] = 2 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Галеон
	case "galeon_h":
		BI_intNRetValue[0] = 4 + 4 * 32;
		BI_intNRetValue[1] = 4 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Галеон
	case "galeon1":
		BI_intNRetValue[0] = 6 + 4 * 32;
		BI_intNRetValue[1] = 6 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Исп. Тяж. Галеон
	case "la_marianna":
		BI_intNRetValue[0] = 8 + 4 * 32;
		BI_intNRetValue[1] = 8 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Призрачный Галеон
	case "piratfastgal":
		BI_intNRetValue[0] = 10 + 4 * 32;
		BI_intNRetValue[1] = 10 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Быстрый Галеон
	case "unicorn":
		BI_intNRetValue[0] = 12 + 4 * 32;
		BI_intNRetValue[1] = 12 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Приватирский Фрегат
	case "revenge":
		BI_intNRetValue[0] = 14 + 4 * 32;
		BI_intNRetValue[1] = 14 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Галеон
	case "linefrigate":
		BI_intNRetValue[0] = 16 + 4 * 32;
		BI_intNRetValue[1] = 16 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лин. Фрегат
	case "lightfrigate":
		BI_intNRetValue[0] = 18 + 4 * 32;
		BI_intNRetValue[1] = 18 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Патр. Корабль
	case "boussole":
		BI_intNRetValue[0] = 20 + 4 * 32;
		BI_intNRetValue[1] = 20 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Воен. Корвет
	case "surprise":
		BI_intNRetValue[0] = 22 + 4 * 32;
		BI_intNRetValue[1] = 22 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фра. фрегат
	case "salamander":
		BI_intNRetValue[0] = 24 + 4 * 32;
		BI_intNRetValue[1] = 24 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Анг. фрегат
	case "frigate_sat":
		BI_intNRetValue[0] = 26 + 4 * 32;
		BI_intNRetValue[1] = 26 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Исп. фрегат
	case "battlefrigate":
		BI_intNRetValue[0] = 28 + 4 * 32;
		BI_intNRetValue[1] = 28 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Гол. фрегат
	case "nightmare":
		BI_intNRetValue[0] = 30 + 4 * 32;
		BI_intNRetValue[1] = 30 + 4 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. фрегат
	case "mordaunt":
		BI_intNRetValue[0] = 0 + 5 * 32;
		BI_intNRetValue[1] = 0 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат Мордаунт
	case "frigate":
		BI_intNRetValue[0] = 2 + 5 * 32;
		BI_intNRetValue[1] = 2 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат
	case "amsterdam":
		BI_intNRetValue[0] = 4 + 5 * 32;
		BI_intNRetValue[1] = 4 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линкор 3-го класса
	case "carraca":
		BI_intNRetValue[0] = 6 + 5 * 32;
		BI_intNRetValue[1] = 6 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Каракка
	// 2-й КЛАСС (21 корабль)
	case "galeon50":
		BI_intNRetValue[0] = 8 + 5 * 32;
		BI_intNRetValue[1] = 8 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Императорский Галеон
	case "fastfrigate":
		BI_intNRetValue[0] = 10 + 5 * 32;
		BI_intNRetValue[1] = 10 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Фрегат
	case "fr_essex":
		BI_intNRetValue[0] = 12 + 5 * 32;
		BI_intNRetValue[1] = 12 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Фрегат
	case "frigate_h":
		BI_intNRetValue[0] = 14 + 5 * 32;
		BI_intNRetValue[1] = 14 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Фрегат
	case "wargalleon2":
		BI_intNRetValue[0] = 16 + 5 * 32;
		BI_intNRetValue[1] = 16 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Воен. Галеон
	case "nl_pinnaceofwar47":
		BI_intNRetValue[0] = 18 + 5 * 32;
		BI_intNRetValue[1] = 18 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Воен. Пинас
	case "hollgaleon_h":
		BI_intNRetValue[0] = 20 + 5 * 32;
		BI_intNRetValue[1] = 20 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Гол. Воен. Галеон
	case "fearless":
		BI_intNRetValue[0] = 22 + 5 * 32;
		BI_intNRetValue[1] = 22 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Усил. Патр. Корабль
	case "lineship":
		BI_intNRetValue[0] = 24 + 5 * 32;
		BI_intNRetValue[1] = 24 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Корабль
	case "nl_fwzp":
		BI_intNRetValue[0] = 26 + 5 * 32;
		BI_intNRetValue[1] = 26 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Анг. Воен. Галеон
	case "constitution":
		BI_intNRetValue[0] = 28 + 5 * 32;
		BI_intNRetValue[1] = 28 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Лин. фрегат
	case "oxford":
		BI_intNRetValue[0] = 30 + 5 * 32;
		BI_intNRetValue[1] = 30 + 5 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат Оксфорд
	case "dutchlineship":
		BI_intNRetValue[0] = 0 + 6 * 32;
		BI_intNRetValue[1] = 0 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Ср. Воен. Корабль
	case "dutchship":
		BI_intNRetValue[0] = 2 + 6 * 32;
		BI_intNRetValue[1] = 2 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Усил. Фрегат
	case "nl_convoiship":
		BI_intNRetValue[0] = 4 + 6 * 32;
		BI_intNRetValue[1] = 4 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Сторожевой Корабль
	case "couronne":
		BI_intNRetValue[0] = 6 + 6 * 32;
		BI_intNRetValue[1] = 6 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фра. Воен. Галеон
	case "alexis":
		BI_intNRetValue[0] = 8 + 6 * 32;
		BI_intNRetValue[1] = 8 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линкор 2-го класса
	case "lineshipheavy":
		BI_intNRetValue[0] = 10 + 6 * 32;
		BI_intNRetValue[1] = 10 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Воен. Корабль
	case "warship":
		BI_intNRetValue[0] = 12 + 6 * 32;
		BI_intNRetValue[1] = 12 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линейный Корабль
	case "heavywarship":
		BI_intNRetValue[0] = 14 + 6 * 32;
		BI_intNRetValue[1] = 14 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Варшип
	case "heavylineship":
		BI_intNRetValue[0] = 16 + 6 * 32;
		BI_intNRetValue[1] = 16 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Лин. Пинас
	// 1-й КЛАСС (20 кораблей)
	case "poseidon":
		BI_intNRetValue[0] = 18 + 6 * 32;
		BI_intNRetValue[1] = 18 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линкор
	case "hms_centurion":
		BI_intNRetValue[0] = 20 + 6 * 32;
		BI_intNRetValue[1] = 20 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линкор
	case "resolution":
		BI_intNRetValue[0] = 22 + 6 * 32;
		BI_intNRetValue[1] = 22 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат Резолюция
	case "fr_superiorwarship1":
		BI_intNRetValue[0] = 24 + 6 * 32;
		BI_intNRetValue[1] = 24 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Корабль
	case "link":
		BI_intNRetValue[0] = 26 + 6 * 32;
		BI_intNRetValue[1] = 26 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Линкор
	case "superbe":
		BI_intNRetValue[0] = 28 + 6 * 32;
		BI_intNRetValue[1] = 28 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Линкор
	case "battleship":
		BI_intNRetValue[0] = 30 + 6 * 32;
		BI_intNRetValue[1] = 30 + 6 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Боевой Корабль
	case "link2":
		BI_intNRetValue[0] = 0 + 7 * 32;
		BI_intNRetValue[1] = 0 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Варшип
	case "bellona":
		BI_intNRetValue[0] = 2 + 7 * 32;
		BI_intNRetValue[1] = 2 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Линкор 1-го класса
	case "linearship":
		BI_intNRetValue[0] = 4 + 7 * 32;
		BI_intNRetValue[1] = 4 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Лин. Корабль
	case "shark":
		BI_intNRetValue[0] = 6 + 7 * 32;
		BI_intNRetValue[1] = 6 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Тяж. Лин. Корабль
	case "Zevenprovincien":
		BI_intNRetValue[0] = 8 + 7 * 32;
		BI_intNRetValue[1] = 8 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Лег. Мановар
	case "fr_trinity":
		BI_intNRetValue[0] = 10 + 7 * 32;
		BI_intNRetValue[1] = 10 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Воен. Мановар
	case "manowar_fast":
		BI_intNRetValue[0] = 12 + 7 * 32;
		BI_intNRetValue[1] = 12 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фра. Мановар
	case "battlemanowar":
		BI_intNRetValue[0] = 14 + 7 * 32;
		BI_intNRetValue[1] = 14 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Анг. Мановар
	case "manowar_gub":
		BI_intNRetValue[0] = 16 + 7 * 32;
		BI_intNRetValue[1] = 16 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Пир. Мановар
	case "prince":
		BI_intNRetValue[0] = 18 + 7 * 32;
		BI_intNRetValue[1] = 18 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Королевский Фрегат
	case "manowar":
		BI_intNRetValue[0] = 20 + 7 * 32;
		BI_intNRetValue[1] = 20 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Гол. Мановар
	case "hms_victory":
		BI_intNRetValue[0] = 22 + 7 * 32;
		BI_intNRetValue[1] = 22 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Мановар Виктория
	case "sp_sanfelipe":
		BI_intNRetValue[0] = 24 + 7 * 32;
		BI_intNRetValue[1] = 24 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Исп. Мановар
			   // КВЕСТОВЫЕ (11 кораблей)
	case "luggerquest":
		BI_intNRetValue[0] = 26 + 7 * 32;
		BI_intNRetValue[1] = 26 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Курьерский Люггер
	case "xebekvml":
		BI_intNRetValue[0] = 28 + 7 * 32;
		BI_intNRetValue[1] = 28 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Щебека
	case "brigqeen":
		BI_intNRetValue[0] = 30 + 7 * 32;
		BI_intNRetValue[1] = 30 + 7 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Бриг
	case "brigsw":
		BI_intNRetValue[0] = 0 + 8 * 32;
		BI_intNRetValue[1] = 0 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Бриг
	case "Clipper":
		BI_intNRetValue[0] = 2 + 8 * 32;
		BI_intNRetValue[1] = 2 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Корвет
	case "corvette_quest":
		BI_intNRetValue[0] = 4 + 8 * 32;
		BI_intNRetValue[1] = 4 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат
	case "Wh_corvette_quest":
		BI_intNRetValue[0] = 6 + 8 * 32;
		BI_intNRetValue[1] = 6 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Корвет
	case "ArabellaShip":
		BI_intNRetValue[0] = 8 + 8 * 32;
		BI_intNRetValue[1] = 8 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат
	case "frigatequeen":
		BI_intNRetValue[0] = 10 + 8 * 32;
		BI_intNRetValue[1] = 10 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Фрегат
	case "Catherine":
		BI_intNRetValue[0] = 12 + 8 * 32;
		BI_intNRetValue[1] = 12 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Королева-Катрин
	case "flyingdutchman":
		BI_intNRetValue[0] = 14 + 8 * 32;
		BI_intNRetValue[1] = 14 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Варшип
	case "santisima":
		BI_intNRetValue[0] = 16 + 8 * 32;
		BI_intNRetValue[1] = 16 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Быстрый мановар
	case "soleyru":
		BI_intNRetValue[0] = 18 + 8 * 32;
		BI_intNRetValue[1] = 18 + 8 * 32 + 1;
		BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break; // Сулей Руаяль
	}
...
void SetParameterData()
{
	...
	if (InterfaceStates.AltIntIcons)
	{
		if (InterfaceStates.HUDStyle)
			BattleInterface.CommandTextures.list.t1.name = "battle_interface\ship_icons1_Konshud.tga";
		else
			BattleInterface.CommandTextures.list.t1.name = "battle_interface\ship_icons1_Konshud.tga";
	}
	else
	...
	if (InterfaceStates.CannonsHUD)
	{
		...
		BattleInterface.textinfo.CannonsNumL.pos.y = sti(showWindow.top) + RecalculateVIcon(makeint(80 * fHtRatio));
		; //RecalculateVIcon(402);
		...
		BattleInterface.textinfo.CannonsNumR.pos.y = sti(showWindow.top) + RecalculateVIcon(makeint(80 * fHtRatio));
		; //RecalculateVIcon(402);
		...
		BattleInterface.textinfo.CannonsNumB.pos.y = sti(showWindow.top) + RecalculateVIcon(makeint(158 * fHtRatio));
		; //RecalculateVIcon(402);
		...
		BattleInterface.textinfo.CannonsNumF.pos.y = sti(showWindow.top) + RecalculateVIcon(makeint(0 * fHtRatio));
		; //RecalculateVIcon(402);
	...
	if (bNewSails)
	{
		if (chrIdx >= 0)
		{
			...
			if (st != SHIP_NOTUSED)
			{
				...
				case 1:
					sUpgrade = "common";
					break; // LEO: --> Все корабли используют
				case 2:
					sUpgrade = "pat";
					break;
				case 3:
				...
				case 38:
					sUpgrade = "sail_torn_black_pirate_1";
					break; // LEO: --> Только пираты
				case 39:
					sUpgrade = "sail_torn_black_pirate_2";
					break;
				case 40:
					sUpgrade = "sail_torn_black_pirate_3";
					break;
				case 41:
					sUpgrade = "sail_torn_black_pirate_4";
					break;
				case 42:
					sUpgrade = "sail_torn_black_pirate_5";
					break;
				case 43:
					sUpgrade = "sail_torn_black_pirate_6";
					break;
				case 44:
					sUpgrade = "sail_torn_black_pirate_7";
					break;
				case 45:
					sUpgrade = "sail_torn_black_pirate_8";
					break;
				case 46:
					sUpgrade = "sail_torn_black_pirate_9";
					break;
				case 47:
					sUpgrade = "sail_torn_black_pirate_10";
					break;
				case 48:
					sUpgrade = "sail_torn_black_pirate_11";
					break;
				case 49:
					sUpgrade = "sail_torn_black_pirate_12";
					break;
				case 50:
					sUpgrade = "sail_torn_black_pirate_13";
					break;
				case 51:
					sUpgrade = "sail_torn_black_pirate_14";
					break;
				case 52:
					sUpgrade = "sail_whole_black_pirate_1";
					break;
				case 53:
					sUpgrade = "sail_whole_black_pirate_2";
					break;
				case 54:
					sUpgrade = "sail_whole_black_pirate_3";
					break;
				case 55:
					sUpgrade = "sail_whole_black_pirate_4";
					break;
				case 56:
					sUpgrade = "sail_whole_black_pirate_5";
					break;
				case 57:
					sUpgrade = "sail_whole_black_pirate_6";
					break;
				case 58:
					sUpgrade = "sail_whole_black_pirate_7";
					break;
				case 59:
					sUpgrade = "sail_whole_black_pirate_8";
					break;
				case 60:
					sUpgrade = "sail_whole_black_pirate_9";
					break;
				case 61:
					sUpgrade = "sail_whole_black_pirate_10";
					break;
				case 62:
					sUpgrade = "sail_whole_black_pirate_11";
					break;
				case 63:
					sUpgrade = "sail_whole_black_pirate_12";
					break;
				case 64:
					sUpgrade = "sail_whole_black_pirate_13";
					break;
				case 65:
					sUpgrade = "sail_whole_black_pirate_14";
					break;
				case 66:
					sUpgrade = "sail_whole_black_pirate_15";
					break;
				case 67:
					sUpgrade = "sail_whole_black_pirate_16";
					break;
				case 68:
					sUpgrade = "sail_whole_black_pirate_17";
					break;
				case 69:
					sUpgrade = "sail_whole_white_pirate_1";
					break;
				case 70:
					sUpgrade = "sail_whole_white_pirate_2";
					break;
				case 71:
					sUpgrade = "sail_whole_white_pirate_3";
					break;
				case 72:
					sUpgrade = "sail_whole_white_pirate_4";
					break;
				case 73:
					sUpgrade = "sail_whole_white_pirate_5";
					break;
				case 74:
					sUpgrade = "sail_whole_white_pirate_6";
					break;
				case 75:
					sUpgrade = "sail_whole_white_pirate_7";
					break;
				case 76:
					sUpgrade = "sail_whole_white_pirate_8";
					break;
				case 77:
					sUpgrade = "sail_whole_white_pirate_9";
					break;
				case 78:
					sUpgrade = "sail_whole_white_pirate_10";
					break;
				case 79:
					sUpgrade = "sail_whole_white_pirate_11";
					break;
				case 80:
					sUpgrade = "sail_whole_white_pirate_12";
					break;
				case 81:
					sUpgrade = "sail_whole_white_pirate_13";
					break;
				case 82:
					sUpgrade = "sail_whole_white_pirate_14";
					break;
				case 83:
					sUpgrade = "sail_whole_white_pirate_15";
					break;
				case 84:
					sUpgrade = "sail_whole_white_pirate_16";
					break;
				case 85:
					sUpgrade = "sail_whole_white_pirate_17";
					break;
				case 86:
					sUpgrade = "sail_whole_white_pirate_18";
					break;
				case 87:
					sUpgrade = "sail_whole_white_pirate_19";
					break;
				case 88:
					sUpgrade = "sail_whole_white_pirate_20";
					break; // LEO: <-- Только пираты
				case 89:
					sUpgrade = "common_torn";
					break;
				case 90:
					sUpgrade = "common_torn1";
					break;
				case 91:
					sUpgrade = "common_torn2";
					break;
				}
...
void MakeSailDmg(int chrIdx, float dmg)
{
	...
	if (CheckAttribute(&RealShips[sti(characters[chrIdx].Ship.Type)], "Tuning.SailsSpecial") && rand(4) > 1)
		return;
	int iSailsUpgrade = 1;
